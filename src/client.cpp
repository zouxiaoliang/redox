...
template <>
unordered_map<long, Command<redisReply *> *> &Redox::getCommandMap<redisReply *>() {
    return commands_redis_reply_;
}

template <>
unordered_map<long, Command<string> *> &Redox::getCommandMap<string>() {
    return commands_string_;
}

template <>
unordered_map<long, Command<char *> *> &Redox::getCommandMap<char *>() {
    return commands_char_p_;
}

template <>
unordered_map<long, Command<int> *> &Redox::getCommandMap<int>() {
    return commands_int_;
}

template <>
unordered_map<long, Command<long long int> *> &Redox::getCommandMap<long long int>() {
    return commands_long_long_int_;
}

template <>
unordered_map<long, Command<nullptr_t> *> &Redox::getCommandMap<nullptr_t>() {
    return commands_null_;
}

template <>
unordered_map<long, Command<vector<string>> *> &Redox::getCommandMap<vector<string>>() {
    return commands_vector_string_;
}

template <>
unordered_map<long, Command<set<string>> *> &Redox::getCommandMap<set<string>>() {
    return commands_set_string_;
}

template <>
unordered_map<long, Command<unordered_set<string>> *> & Redox::getCommandMap<unordered_set<string>>() {
