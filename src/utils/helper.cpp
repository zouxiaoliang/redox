...
void redox::util::split(std::string content, std::vector<std::string> &r, const char *sep)
{
...
uint16_t redox::util::crc16(const char *buf, int len) {
    int counter;
    uint16_t crc = 0;
...
uint32_t redox::util::hash_slot(const char *key, int32_t keylen)
{
